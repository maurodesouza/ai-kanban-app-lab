...
**Decision**: Use modal.show and modal.hide events following existing pattern  
**Rationale**: Consistent with existing event naming conventions and modal store operations  
