...
const buttonVariants = tv({
  base: "flex items-center justify-center gap-xs rounded-full hover:!no-underline shrink-0 focus:ring-[2px] focus:ring-ring-outer min-h-[44px] min-w-[44px]",
  variants: {
    tone: {
    ...
    size: {
      icon: "size-control-height justify-center",
      default: "h-control-height px-md py-xs",
    },
