...
function KanbanHandler() {
  function onFilter(payload: unknown) {
    const event = payload as CustomEvent<FilterPayload>;
  ...
  function onCreateTask(payload: unknown) {
    const event = payload as CustomEvent<CreateTaskPayload>;
  ...
  function onUpdateTask(payload: unknown) {
    const event = payload as CustomEvent<UpdateTaskPayload>;
  ...
  function onDeleteTask(payload: unknown) {
    const event = payload as CustomEvent<DeleteTaskPayload>;
  ...
  function onMoveTask(payload: unknown) {
    const event = payload as CustomEvent<MoveTaskPayload>;
    const { storeId, taskId, fromColumnId, toColumnId, newIndex } = event.detail;
    const store = kanbanStore.getById(storeId);
  ...
  function onCreateColumn(payload: unknown) {
    const event = payload as CustomEvent<CreateColumnPayload>;
    const { storeId, data } = event.detail;
    const store = kanbanStore.getById(storeId);
  ...
  function onUpdateColumn(payload: unknown) {
    const event = payload as CustomEvent<UpdateColumnPayload>;
  ...
  function onDeleteColumn(payload: unknown) {
    const event = payload as CustomEvent<DeleteColumnPayload>;
  ...
  function onMoveColumn(payload: unknown) {
    const event = payload as CustomEvent<MoveColumnPayload>;
    const { storeId, columnId, direction } = event.detail;
    moveColumnInDirection(storeId, columnId, direction);
  }
  ...
  useEffect(() => {
    ...
    events.on(Events.KANBAN_COLUMN_MOVE, onMoveColumn);
    ...
    return () => {
      ...
      events.off(Events.KANBAN_COLUMN_MOVE, onMoveColumn);
