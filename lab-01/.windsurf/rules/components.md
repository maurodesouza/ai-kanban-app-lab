...
#### Use `tailwind-variants (tv)` when:

* The component has variants (size, tone, state, etc.)
...
* The component is static or simple
* No variants are required

---

### Variant Pattern

* All variant-based components must:

  * Define variants using `tv`
  * Use `VariantProps<typeof variants>`
