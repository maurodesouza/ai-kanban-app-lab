...
This project uses an **event-based pub/sub pattern** to decouple UI from state logic. The system is agnostic regarding the state manager (Zustand, etc.). 
